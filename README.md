...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hcipy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14276&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hcipy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hcipy` can be installed with:

```
conda install hcipy
```

It is possible to list all of the versions of `hcipy` available on your platform with:
